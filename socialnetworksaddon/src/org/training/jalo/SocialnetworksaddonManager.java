...
/**
 * This is the extension manager of the Socialnetworksaddon extension.
 */
public class SocialnetworksaddonManager extends GeneratedSocialnetworksaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SocialnetworksaddonManager.class.getName());
	 ...
	 */
	public static SocialnetworksaddonManager getInstance()
	{
		return (SocialnetworksaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SocialnetworksaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SocialnetworksaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SocialnetworksaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SocialnetworksaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SocialnetworksaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
