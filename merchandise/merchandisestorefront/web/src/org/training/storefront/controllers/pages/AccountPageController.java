...
public class AccountPageController extends AbstractSearchPageController
{
	...
	private static final String WISHLIST_DATA_ATTR = "wishlistData";
	...
	@Resource(name = "productWishlistConvertFacade")
	private ProductWishlistConvertFacade productWishlistFacade;
	...
	@RequireHardLogIn
	public String editProfile(final Model model) throws CMSItemNotFoundException, ParseException
	{
			...
			throws CMSItemNotFoundException
	{
		...
		final List<ProductModel> searchPageData = wishlistFacade.getWishlist();

		model.addAttribute("searchPageData", productWishlistFacade.convertWishlistToProductData(searchPageData));
