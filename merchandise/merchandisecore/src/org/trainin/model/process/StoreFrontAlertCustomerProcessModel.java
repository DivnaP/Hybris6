 ...
 * 
 */
package org.trainin.model.process;
 ...
 *
 */
public class StoreFrontAlertCustomerProcessModel extends StoreFrontProcessModel
{
	 ...
	 */
	public StoreFrontAlertCustomerProcessModel()
	{
		super();
	}
	 ...
	 */
	public StoreFrontAlertCustomerProcessModel(final ItemModelContext ctx)
	{
		super(ctx);
	}
	 ...
	 */
	@Deprecated
	public StoreFrontAlertCustomerProcessModel(final String _code, final String _processDefinitionName)
	{
		super();
		setCode(_code);
	 ...
	 */
	@Deprecated
	public StoreFrontAlertCustomerProcessModel(final String _code, final ItemModel _owner, final String _processDefinitionName)
	{
		super();
		setCode(_code);
		setOwner(_owner);
