 ...
 */
public class CustomRegistrationEventListener extends AbstractAcceleratorSiteEventListener<RegisterEvent>
{
	 ...
	 */
	@Override
	protected SiteChannel getSiteChannelForEvent(RegisterEvent event)
	{
	 ...
	 */
	@Override
	protected void onSiteEvent(RegisterEvent registerEvent)
	{
		final StoreFrontCustomerProcessModel storeFrontCustomerProcessModel = (StoreFrontCustomerProcessModel	) getBusinessProcessService()
				.createProcess(
						"customerAlertRegistrationEmailProcess-" + registerEvent.getCustomer().getUid() + "-" + System.currentTimeMillis(),
						"customerAlertRegistrationEmailProcess");
